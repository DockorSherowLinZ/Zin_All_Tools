macroScript ResetModel_v1_2
category:"ZinAllTools"
tooltip:"ResetModel v1.2: Align Pivot, Clean, Add Marker (Empty Shell Filter)"
(
    rollout ResetModel_UI "ResetModel v1.2" width:300 height:130
    (
        -- 介面需求
