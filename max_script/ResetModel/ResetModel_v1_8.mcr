macroScript ResetModel_v1_8
category:"ZinAllTools"
tooltip:"ResetModel v1.8: Full Hierarchy Transform, Clean, Log"
(
    rollout ResetModel_UI "ResetModel v1.8" width:300 height:175
    (
        -- 介面需求
        ...
        (
            ...
            -- 初始化 Log 並寫入開頭
            initLogFile()
            writeLog "=== ResetModel Auto Clean Started (v1.8) ==="
