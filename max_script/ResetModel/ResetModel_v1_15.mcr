macroScript ResetModel_v1_15
category:"ZinAllTools"
tooltip:"ResetModel v1.15: Batch STEP Import, Transform Preprocess, Prefix, Scope-based Attach Identical, Full Auto"
(
    rollout ResetModel_UI "ResetModel v1.15" width:420 height:390
    (
        -- ========== UI 元素 ==========
        ...
        (
            ...
            -- [v1.15] 加入 Parent 識別，確保只在同一個群組內 Attach
            local parentKey = if node.parent != undefined then ((getHandleByAnim node.parent) as string) else "ROOT"
            
            -- 指紋 = 大寫BaseName + Parent + XYZ縮放 + 總面數 + 總頂點數
        ...
        (
            ...
            (
                ...
                writeLog "============================================"
                writeLog "=== ResetModel Batch Processing Started (v1.15) ==="
            ...
            (
                ...
                initLogFile()
                writeLog "=== ResetModel Manual Clean Started (v1.15) ==="
