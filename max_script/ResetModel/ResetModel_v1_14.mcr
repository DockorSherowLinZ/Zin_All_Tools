macroScript ResetModel_v1_14
category:"ZinAllTools"
tooltip:"ResetModel v1.14: Batch STEP Import, Transform Preprocess, Prefix, Attach Identical, Full Auto"
(
    rollout ResetModel_UI "ResetModel v1.14" width:420 height:390
    (
        -- ========== UI 元素 ==========
        ...
        (
            ...
            (
                ...
                writeLog "============================================"
                writeLog "=== ResetModel Batch Processing Started (v1.14) ==="
                ...
                (
                    ...
                    (
                        ...
                        (
                            ...
                            -- Phase 4.5: 相同 Mesh Attach (不同位置/旋轉)
                            if doAttachIdentical do
                            (
                                writeLog "--- Scanning for Identical Meshes to Attach ---"
            ...
            (
                ...
                initLogFile()
                writeLog "=== ResetModel Manual Clean Started (v1.14) ==="
                ...
                (
                    ...
                    (
                        ...
                        (
                            writeLog "--- Scanning for Identical Meshes to Attach ---"
                            local attachResult = attachIdenticalMeshes rootNodes
                            if attachResult[1] > 0 do
                            (
                                totalNodesCount = 0
                                for rNode in rootNodes do
