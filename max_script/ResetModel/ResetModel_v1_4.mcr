macroScript ResetModel_v1_4
category:"ZinAllTools"
tooltip:"ResetModel v1.4: Sync Parent Pivot, Clean, Optional Marker"
(
    rollout ResetModel_UI "ResetModel v1.4" width:300 height:145
    (
        -- 介面需求
        ...
        (
            ...
            (
                ...
                (
                    ...
                    if originalParent != undefined do
                    (
                        if newPt != undefined do newPt.parent = originalParent -- 將新標記放回原 CAD 結構
